...
function App() {
  ...
  return (
    ...
    <div className="position-absolute p-5 bg-dark w-100 h-100 text-light">
      <h1 className="display-3 d-flex align-items-center justify-content-center mt-5">Login</h1>
      <form className="form-group d-flex flex-column align-items-center justify-content-center gap-2 w-100 h-50 mt-4">
        <label>Email:</label>
        <input type="email" placeholder="Email..." className="form-control w-100" onChange={(e)=>{setEmail(e.target.value)}}/>
        <label>Senha:</label>
        <input type="password" placeholder="Senha..." className="form-control w-100" onChange={(e)=>{setSenha(e.target.value)}}/>
        <button className="btn btn-success mt-4 w-50" onClick={logar}>Logar</button>
